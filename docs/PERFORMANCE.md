...
|------|:----------:|:------:|:------:|:----------:|
| naive | 35.19 | 3.91 | 1.0× | 10.0% |
| v1 Shared Mem Tiling | 5.63 | 24.43 | 6.2× | 62.5% |
| v2 Bank Conflict Avoid. | 4.86 | 28.30 | 7.2× | 72.4% |
| v3 Double Buffering | 3.64 | 37.77 | 9.7× | 96.7% |
| cuBLAS (cutlass) | ~3.46 | ~39.08 | — | 100% |
...
| M=N=K | v1 (TFLOPS) | v2 (TFLOPS) | v3 (TFLOPS) | v4 (TFLOPS) | cuBLAS |
|:-----:|:-----------:|:-----------:|:-----------:|:-----------:|:------:|
| 1024 | 44.9 | 48.7 | 52.9 | 52.4 | 70.6 |
| 2048 | 96.4 | 104.3 | 130.1 | 119.8 | 232.7 |
| 4096 | 151.9 | 159.6 | 212.8 | 194.3 | 455.3 |
| 8192 | — | — | — | — | — |

> *大尺寸数据需运行 `./cuda_gemm --bench` 获取。*
